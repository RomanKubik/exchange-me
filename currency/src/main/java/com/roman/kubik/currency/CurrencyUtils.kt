package com.roman.kubik.currency
...
object CurrencyUtils {
    ...
    @DrawableRes
    fun getCurrencyFlag(currency: Currency): Int {
        return currencyFlags[currency] ?: R.drawable.flag_default
    }

    @StringRes
    fun getCurrencyName(currency: Currency): Int {
        return currencyNames[currency] ?: R.string.currency_unknown
    }
